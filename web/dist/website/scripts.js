...
var _mustache = __webpack_require__(119);
...
var _DataField = __webpack_require__(65);
...
var Component = function () {
    ...
    (0, _createClass3.default)(Component, [{
        ...
        value: function render(data) {
            ...
            return this.template.then(function (template) {
...
var _exports = __webpack_require__(62);

var Components = _interopRequireWildcard(_exports);
...
var _RestStore2 = __webpack_require__(67);

var _RestStore3 = _interopRequireDefault(_RestStore2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ClockApi = function (_RestStore) {
    (0, _inherits3.default)(ClockApi, _RestStore);

    function ClockApi() {
        (0, _classCallCheck3.default)(this, ClockApi);
        return (0, _possibleConstructorReturn3.default)(this, (ClockApi.__proto__ || (0, _getPrototypeOf2.default)(ClockApi)).call(this, '/clock/api'));
    }

    (0, _createClass3.default)(ClockApi, [{
        key: 'test',
        value: function test() {
...
var _Component2 = __webpack_require__(26);
...
var Test = function (_Component) {
    ...
    function Test(ctx, node) {
        (0, _classCallCheck3.default)(this, Test);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Test.__proto__ || (0, _getPrototypeOf2.default)(Test)).call(this, ctx, node));

        _this.clock = ctx.getStore('ClockApi');
        return _this;
    }
    ...
    (0, _createClass3.default)(Test, [{
        ...
        value: function onTest(data) {
            alert('test executed: ' + (0, _stringify2.default)(data));
        }
    }]);
    return Test;
}(_Component3.default);
...
var DataBinding = function () {
    function DataBinding() {
        (0, _classCallCheck3.default)(this, DataBinding);
    }

    (0, _createClass3.default)(DataBinding, [{
        key: 'inputChange',
        value: function inputChange(node) {
            ...
            return {
                set: function set(target, prop, newValue) {
                    if (prop == 'value' && target.id) {
                        ...
                        (0, _jquery2.default)('[data-bind="' + target.id + '"]').val(newValue);
                        return true;
                    } else return false;
                },
...
var _DataBinding = __webpack_require__(64);
...
var DataField = function () {
    ...
    (0, _createClass3.default)(DataField, [{
        key: 'bind',
        value: function bind() {
            this.dataBinding = new _DataBinding2.default();
...
var _Mediator = __webpack_require__(63);

var _Mediator2 = _interopRequireDefault(_Mediator);

var _DataStore2 = __webpack_require__(66);

var _DataStore3 = _interopRequireDefault(_DataStore2);

var _StoreAction = __webpack_require__(68);
...
var RestStore = function (_DataStore) {
    ...
    (0, _createClass3.default)(RestStore, [{
        ...
        key: 'delete',
        value: function _delete(entry) {
            return this.request(_StoreAction2.default.DELETE, 'DELETE', entry);
        }
    }, {
        key: 'load',
        value: function load(entry) {
        ...
        key: 'call',
        value: function call(type, payload) {
            var event = payload.action || type;
            return this.request(event, type, payload);
        }
    }, {
        key: 'request',
...
var _ClockApi = __webpack_require__(58);

var _ClockApi2 = _interopRequireDefault(_ClockApi);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery2.default)(function () {
    new _App2.default().withDataStore(new _ClockApi2.default()).run((0, _jquery2.default)('body'));
});
